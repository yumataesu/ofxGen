...
uniform Layer layer[Max_Layer_Num];
...
void main() {
    ...
    if(u_layer_num == 1) {
        ...
        float d4 = texture(layer[4].depth, v_texcoord).r;
        float d5 = texture(layer[5].depth, v_texcoord).r;
        float d6 = texture(layer[6].depth, v_texcoord).r;
        ...
        vec4 c4  = texture(layer[4].color, v_texcoord);
        vec4 c5  = texture(layer[5].color, v_texcoord);
        vec4 c6  = texture(layer[6].color, v_texcoord);
        ...
        vec4 p4  = texture(layer[4].position, v_texcoord);
        vec4 p5  = texture(layer[5].position, v_texcoord);
        vec4 p6  = texture(layer[6].position, v_texcoord);
        ...
        vec4 col_result5 = vec4(mix(col_result4.rgb, c5.rgb * layer[5].alpha, step(vec3(d5), vec3(depth_result4))), 1.0);
        vec4 position_result5 = vec4(mix(position_result4.rgb, p5.rgb, step(vec3(d5), vec3(depth_result4))), 1.0);
        float depth_result5 = min(depth_result4, d5);

        fragColor_color = vec4(mix(col_result5.rgb, c6.rgb * layer[6].alpha, step(vec3(d6), vec3(depth_result5))), 1.0);
        world = vec4(mix(position_result5.rgb, p5.rgb, step(vec3(d6), vec3(depth_result5))), 1.0);
        fragColor_position = world;
        fragColor_normal = vec4(calcFlatNormal(vec3(world.x, world.y, world.z)), 1.0);
        gl_FragDepth = min(depth_result5, d6);

    }
    else if(u_layer_num == 8) {
        float d0 = texture(layer[0].depth, v_texcoord).r;
        float d1 = texture(layer[1].depth, v_texcoord).r;
        float d2 = texture(layer[2].depth, v_texcoord).r;
        float d3 = texture(layer[3].depth, v_texcoord).r;
        ...
        float d5 = texture(layer[5].depth, v_texcoord).r;
        float d6 = texture(layer[6].depth, v_texcoord).r;
        float d7 = texture(layer[7].depth, v_texcoord).r;
        ...
        vec4 c5  = texture(layer[5].color, v_texcoord);
        vec4 c6  = texture(layer[6].color, v_texcoord);
        vec4 c7  = texture(layer[7].color, v_texcoord);
        ...
        vec4 p5  = texture(layer[5].position, v_texcoord);
        vec4 p6  = texture(layer[6].position, v_texcoord);
        vec4 p7  = texture(layer[7].position, v_texcoord);
        ...
        vec4 col_result6 = vec4(mix(col_result5.rgb, c6.rgb * layer[6].alpha, step(vec3(d6), vec3(depth_result5))), 1.0);
        vec4 position_result6 = vec4(mix(position_result5.rgb, p5.rgb, step(vec3(d6), vec3(depth_result5))), 1.0);
        float depth_result6 = min(depth_result5, d6);

        fragColor_color = vec4(mix(col_result6.rgb, c7.rgb * layer[7].alpha, step(vec3(d7), vec3(depth_result6))), 1.0);
        world = vec4(mix(position_result6.rgb, p6.rgb, step(vec3(d7), vec3(depth_result6))), 1.0);
        fragColor_position = world;
        fragColor_normal = vec4(calcFlatNormal(vec3(world.x, world.y, world.z)), 1.0);
        gl_FragDepth = min(depth_result6, d7);
    }
}
